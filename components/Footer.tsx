...
const FOOTER_LINKS = [
  {
    ...
    links: [
      { label: "Original Medicare", href: "/pillar-page" },
      { label: "Medicare Advantage", href: "/pillar-page" },
      { label: "Medicare Supplement", href: "/pillar-page" },
      { label: "Part D Drug Plans", href: "/pillar-page" },
      { label: "Compare Plans", href: "/pillar-page" },
    ],
  },
  {
    heading: "Enrollment",
    links: [
      { label: "Turning 65", href: "/" },
      { label: "Annual Enrollment", href: "/" },
      { label: "Special Enrollment", href: "/" },
      { label: "Avoid Penalties", href: "/" },
      { label: "How to Enroll", href: "/" },
    ],
  },
  {
    heading: "Resources",
    links: [
      { label: "Blog & Articles", href: "/blog-post" },
      { label: "Coverage Search", href: "/coverage-qa" },
      { label: "Medicare 101", href: "/" },
      { label: "FAQ Center", href: "/" },
      { label: "About Us", href: "/" },
    ],
  },
];
