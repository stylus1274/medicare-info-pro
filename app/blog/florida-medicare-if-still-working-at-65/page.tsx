...
const POST = {
  ...
  imageAlt: "Senior professional still working at 65 considering Medicare enrollment in Florida",
  sections: [
    {
      type: "intro" as const,
      content:
    ...
    },
    {
      ...
      content:
        "Medicare Part A (hospital insurance) is premium-free for most people who have worked and paid Medicare taxes for at least 40 quarters. Because it costs nothing, many financial advisors recommend enrolling in Part A at 65 regardless of your employment status.\n\nPart A provides secondary coverage for hospital stays, which can reduce your out-of-pocket costs even when your employer plan is primary.\n\n<strong>The HSA exception:</strong> There is one important reason to delay Part A. If you are enrolled in a High Deductible Health Plan (HDHP) and contributing to a Health Savings Account (HSA), enrolling in any part of Medicare stops your ability to contribute to that HSA.\n\n<strong>Important HSA timing note:</strong> Medicare Part A coverage can be backdated up to 6 months when you enroll after 65. Any HSA contributions made during that backdated period would be considered excess contributions and subject to a 6% excise tax. Plan your last HSA contribution carefully in the months before you intend to enroll.",
    },
    {
      type: "section" as const,
      heading: "What Happens When You Retire: The Special Enrollment Period",
      content:
        "When you stop working or lose your qualifying employer coverage, you enter a Special Enrollment Period (SEP) for Medicare Part B. This is a critical window that many people misunderstand.\n\n<strong>The SEP is 8 months long</strong> and begins on the earlier of the month your employment ends or the month your employer group health plan coverage ends. You can enroll in Part B up to 3 months before your coverage ends if you know your end date in advance.\n\n<strong>Common mistakes that cost people their SEP:</strong>\n\n<ul><li><strong>Waiting until COBRA ends:</strong> COBRA is not qualifying employer coverage for SEP purposes. Your 8-month SEP begins when your active employment ends, not when COBRA expires.</li><li><strong>Relying on retiree coverage:</strong> Retiree health benefits from a former employer are not qualifying coverage. Your SEP still begins when your active employment ends.</li><li><strong>Missing the 8-month window:</strong> If you miss your SEP, you must wait for the General Enrollment Period and will owe a permanent Part B late enrollment penalty of 10% for each 12-month period you were eligible but not enrolled.</li></ul>",
    },
    {
      type: "section" as const,
      heading: "Coordinating Medicare with Your Employer Plan",
      content:
        "If you enroll in both Medicare and keep your employer coverage, understanding how the two plans coordinate is important. The rules differ based on your employer's size.\n\n<strong>When employer plan is primary (20+ employee companies):</strong> Your employer plan pays first and Medicare Part B pays second. Having both coverages can significantly reduce your out-of-pocket costs for medical services.\n\n<strong>When Medicare is primary (fewer than 20 employee companies):</strong> Medicare pays first and your employer plan pays second. If you are not enrolled in Medicare Part B, your employer plan may not pay for services that Medicare would have covered as primary.\n\n<strong>Network considerations:</strong> Medicare works with any provider that accepts Medicare, while your employer plan may have a narrower network. When Medicare is secondary, you generally need providers that accept both plans.\n\n<strong>Drug coverage:</strong> If your employer drug coverage is at least as good as Medicare Part D (creditable coverage), you can delay Part D enrollment without penalty. Keep your annual creditable coverage notice, as you will need it when you eventually enroll in Part D.",
    },
    {
      type: "section" as const,
