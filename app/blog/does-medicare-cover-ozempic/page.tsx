...
const POST = {
  ...
  title: "Does Medicare Cover Ozempic? Coverage, Costs, and Alternatives",
  excerpt:
    "Ozempic is one of the most prescribed medications in the country, but Medicare coverage depends entirely on why your doctor prescribed it. For diabetes, coverage is generally available through Part D. For weight loss alone, coverage is more limited. Here is what you need to know.",
    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          text: "Until recently, Medicare was prohibited by law from covering drugs used solely for weight loss. This meant Wegovy (semaglutide for weight management) was not covered by Medicare Part D even though it contains the same active ingredient as Ozempic.",
        },
        {
        ...
        },
        {
          ...
          text: "Even when Medicare allows coverage, individual Part D plans decide which drugs to include on their formulary and at what tier. Ozempic is often placed on a high tier (Tier 4 or 5), resulting in significant cost-sharing.",
        },
        {
      ...
      items: [
        {
          ...
          answer:
            "Not typically. Medicare Part D has historically excluded drugs used solely for weight loss. However, following 2024 CMS guidance, Medicare Part D plans may now cover semaglutide (Wegovy) for patients with established cardiovascular disease (prior heart attack, stroke, or peripheral arterial disease) and a BMI of 27 or higher. Coverage for weight loss without a cardiovascular disease diagnosis remains limited.",
        },
        {
        ...
        },
        {
          ...
          answer:
            "Your cost depends on your plan's tier placement and where you are in the benefit year. After your deductible, you typically pay 25% coinsurance. Given Ozempic's list price of approximately $935/month, many beneficiaries reach the $2,000 annual out-of-pocket cap within the first 2 to 3 months, after which the drug costs $0 for the rest of the year.",
        },
        {
