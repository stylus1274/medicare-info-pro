  ...
  sections: [
    ...
    },
    {
      ...
      items: [
        ...
        {
          label: "Part D out-of-pocket cap is now $2,000",
          text: "A major positive change: the Inflation Reduction Act capped annual out-of-pocket drug costs at $2,000 for Medicare Part D in 2025, and this cap continues in 2026. This is a significant benefit for people with high drug costs.",
        },
        {
      ...
      items: [
        {
          ...
          answer:
            "The most significant positive change is the continuation of the $2,000 annual out-of-pocket cap for Part D drug costs under the Inflation Reduction Act. On the cost side, CMS raised the maximum allowed in-network out-of-pocket limit to $9,350, and many plans moved their limits higher. Extra benefits like OTC allowances and dental were also reduced on many plans.",
        },
        {
