...
const POST = {
  ...
  imageAlt: "Senior receiving quality healthcare representing why Medicare coverage is essential",
  sections: [
    {
      type: "intro" as const,
      content:
