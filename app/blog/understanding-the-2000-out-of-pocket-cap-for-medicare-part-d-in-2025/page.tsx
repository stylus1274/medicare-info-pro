...
export const metadata: Metadata = {
  ...
  description:
    "The $2,000 Medicare Part D out-of-pocket cap took effect in 2025. Learn how it works, what counts toward the cap, how the Medicare Prescription Payment Plan helps, and what it means for your drug costs.",
  keywords: [
    "$2000 Medicare Part D cap",
    "Medicare Part D out of pocket maximum 2025",
    "Medicare Part D cap 2026",
    "Medicare Prescription Payment Plan",
    "Part D catastrophic coverage 2025",
    "Medicare drug cost cap Florida",
  ],
  openGraph: {
    title: "Understanding the $2,000 Out-of-Pocket Cap for Medicare Part D in 2025 and 2026",
    description:
      "How the $2,000 Part D cap works, what counts toward it, and how the Medicare Prescription Payment Plan lets you spread costs across the year.",
  ...
  twitter: {
    ...
    title: "Understanding the $2,000 Out-of-Pocket Cap for Medicare Part D in 2025 and 2026",
    description:
      "How the $2,000 Part D cap works and what it means for your prescription drug costs.",
  },
  alternates: {
    canonical:
...
const POST = {
  slug: "understanding-the-2000-out-of-pocket-cap-for-medicare-part-d-in-2025",
  title: "Understanding the $2,000 Out-of-Pocket Cap for Medicare Part D in 2025 and 2026",
  excerpt:
    "Starting in 2025, Medicare Part D has a $2,000 annual out-of-pocket cap on prescription drug costs. This is one of the most significant changes to Medicare in decades, eliminating the coverage gap (donut hole) and providing real financial protection for beneficiaries with high drug costs. Here is what you need to know.",
  category: "Part D" as const,
  author: GREG_WOHL,
  date: "June 2026",
  readTime: "9 min read",
  image: "https://images.unsplash.com/photo-1471864190281-a93a3070b6de?w=1200&q=80",
  imageAlt: "Pharmacy prescription counter representing the Medicare Part D $2,000 out-of-pocket cap",
  sections: [
    {
      type: "intro" as const,
      content:
        "The Inflation Reduction Act of 2022 made sweeping changes to Medicare Part D, and the most impactful took effect on January 1, 2025: a $2,000 annual out-of-pocket cap on covered prescription drug costs.\n\nBefore 2025, there was no cap on what Medicare beneficiaries could pay out of pocket for drugs in a single year. Beneficiaries with expensive specialty medications could spend $5,000, $10,000, or more annually. The new cap changes that fundamentally.\n\nThis guide explains exactly how the cap works, what counts toward it, how the new Medicare Prescription Payment Plan helps spread costs, and what the changes mean for your plan selection.",
    },
    {
      type: "keyTakeaways" as const,
      items: [
        {
          label: "The $2,000 cap is now in effect",
          text: "Starting January 1, 2025, Medicare Part D has a $2,000 annual out-of-pocket cap. Once you reach $2,000 in qualifying out-of-pocket costs, you pay $0 for covered drugs for the rest of the year.",
        },
        {
          label: "The donut hole is eliminated",
          text: "The coverage gap (donut hole) that previously required beneficiaries to pay a higher share of drug costs no longer exists. The Part D benefit now has three phases: deductible, initial coverage, and catastrophic coverage (at $2,000).",
        },
        {
          label: "Not all costs count toward the cap",
          text: "Only your out-of-pocket costs for covered drugs count toward the $2,000 cap. Premiums do not count. Costs for drugs not on your plan's formulary do not count. Extra Help subsidies do not count toward your cap.",
        },
        {
        ...
        },
        {
          ...
          text: "Beneficiaries who qualify for Extra Help (the Low Income Subsidy) have copays capped at $4.50 for generics and $11.20 for brand-name drugs in 2026. These beneficiaries are unlikely to reach the $2,000 cap.",
        },
        {
    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          answer:
            "Yes. The $2,000 cap applies to all Medicare Part D drug coverage, including Medicare Advantage plans that include prescription drug coverage (MAPD plans). The cap is a federal requirement that applies to all Part D plans.",
        },
        {
          question: "Do manufacturer coupons or patient assistance programs count toward the cap?",
          answer:
            "Generally, no. Costs paid by third parties (manufacturer coupons, patient assistance programs, charities) typically do not count toward the $2,000 cap. Only your own out-of-pocket payments and applicable manufacturer discounts under the Part D benefit count.",
        },
      ],
    },
  ],
