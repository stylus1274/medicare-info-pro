...
const POST = {
  ...
  keyTakeaways: [
    { label: "$2,000 Annual Cap", text: "Once you spend $2,000 out of pocket on covered Part D drugs in a calendar year, your plan covers 100 percent of drug costs for the rest of the year." },
    { label: "Manufacturer Discounts Count", text: "Manufacturer discounts on brand-name drugs count toward your $2,000 cap, even though you do not pay them directly." },
    { label: "Premiums Do Not Count", text: "Monthly Part D premiums do not count toward the $2,000 cap — only pharmacy payments (deductibles, copays, coinsurance) count." },
  ...
  quickFacts: [
    { label: "Annual Cap Amount", value: "$2,000 (2026)" },
  ...
  sections: [
    ...
    },
    {
      ...
      heading: "How the $2,000 Cap Works",
...
The $2,000 cap is a true out-of-pocket maximum for covered Part D drugs. Once the amounts you pay at the pharmacy total $2,000 in a calendar year, your plan pays 100 percent of the cost of covered drugs for the remainder of that year. You pay nothing at the pharmacy for covered drugs after reaching the cap.
...
The cap resets on January 1 each year. There is no carryover from one year to the next. If you reach $2,000 in October, you benefit from free covered drugs in November and December, but you start over at $0 on January 1.`,
    },
    {
      type: "section" as const,
...
To qualify for Extra Help, your income must be below 150 percent of the federal poverty level and your resources must be below certain limits. You can apply through Social Security at ssa.gov or by calling 1-800-772-1213. A <a href='/get-help' class='text-[#1a3fa8] underline underline-offset-2'>licensed Medicare advisor</a> can also help you determine whether you qualify and assist with the application.`,
    ...
    },
    {
      ...
      items: [
        ...
        { question: "What if I also have Extra Help?", answer: "If you receive the Low Income Subsidy (Extra Help), your copays are already very low. You are unlikely to reach the $2,000 cap, but the cap still applies as a backstop. Extra Help and the $2,000 cap work together to protect low-income beneficiaries from high drug costs." },
      ],
    },
  ],
  relatedPosts: [
