...
/**
 * Homepage preview only: preserves the established homepage visual system while
 * surfacing verified Brandon and Tampa local actions, usable content paths, and
 * practical visit-preparation help. Never use client reviews, rating graphics,
 * savings claims, or unverified outcomes in this preview.
 */
    ...
    <div style={{ fontFamily: "'Plus Jakarta Sans', 'Inter', sans-serif", background: "#f8f7f4", minHeight: "100vh" }}>
      ...
      <section style={{ width: "100%", margin: 0, padding: 0 }}>
        <div className="grid grid-cols-1 lg:grid-cols-2" style={{ borderRadius: 0, overflow: "hidden", minHeight: 560 }}>
          ...
          <div className="min-h-[280px] lg:min-h-0" style={{ position: "relative", overflow: "hidden" }}>
            ...
            {/* Preview design: verified Brandon office details replace unsupported review and client-count content. */}
            <div className="hidden lg:block" style={{
              position: "absolute", bottom: 32, left: 32,
              background: "rgba(255,255,255,0.95)", backdropFilter: "blur(12px)",
              borderRadius: 14, padding: "1rem 1.4rem",
              boxShadow: "0 8px 32px rgba(0,0,0,0.15)", minWidth: 225,
            }}>
              <div className="flex items-center gap-2" style={{ color: "#1a3fa8", fontWeight: 800, fontSize: "0.78rem", letterSpacing: "0.05em", textTransform: "uppercase" }}><MapPin size={15} /> Brandon Office</div>
              <div style={{ fontSize: "1.15rem", fontWeight: 800, color: "#0d1f5c", marginTop: "0.45rem", lineHeight: 1.25 }}>Serving Brandon and Tampa</div>
              <div style={{ fontSize: "0.78rem", color: "#4b5563", marginTop: "0.45rem", lineHeight: 1.5 }}>915 Oakfield Dr, Suite A<br />Brandon, FL 33511</div>
              <Link href="/contact/" style={{ display: "inline-flex", marginTop: "0.65rem", color: "#1a3fa8", fontWeight: 700, fontSize: "0.78rem", textDecoration: "underline" }}>Contact the office <ArrowRight size={13} style={{ margin: "0.1rem 0 0 0.25rem" }} /></Link>
            </div>
          </div>
          <div className="lg:hidden flex items-center gap-3 px-6 py-4" style={{ background: "#f8f9fb", borderTop: "1px solid #e8eaf0" }}>
            <MapPin size={18} style={{ color: "#1a3fa8", flexShrink: 0 }} />
            <div style={{ fontSize: "0.87rem", color: "#1f2937", fontWeight: 650 }}>Brandon office serving Tampa Bay. <Link href="/contact/" style={{ color: "#1a3fa8", textDecoration: "underline" }}>Contact us</Link></div>
          </div>
        </div>
      </section>

      <LocalAssistancePanel />
      ...
      <section id="journey" className="py-10 lg:py-12" style={{ background: "white" }}>
        <div className="max-w-[1320px] mx-auto px-5 sm:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              { img: "https://d2xsxph8kpxj0f.cloudfront.net/310419663028505829/WdenMMm9jE8SydxXzr6dkt/journey-new-medicare-v2-j3d35iiZZX3bqSXQUaRxTp.webp", color: "#2563eb", badge: "New to Medicare", title: "Getting started for the first time", desc: "Learn the basics, understand your options, and get a clear action plan.", href: "/am-i-eligible/" },
              { img: "https://d2xsxph8kpxj0f.cloudfront.net/310419663028505829/WdenMMm9jE8SydxXzr6dkt/journey-working-65_04a993cd.jpg", color: "#dc2626", badge: "Working Past 65", title: "Balancing employer coverage with Medicare", desc: "Know when to enroll, what to keep, and how to avoid costly penalties.", href: "/working-past-65/" },
              { img: "https://d2xsxph8kpxj0f.cloudfront.net/310419663028505829/WdenMMm9jE8SydxXzr6dkt/journey-already-enrolled_8b3cb1ab.jpg", color: "#059669", badge: "Already Enrolled", title: "Reviewing, switching, or improving your plan", desc: "Make sure you have the best coverage for your needs and budget.", href: "/switch-medicare-advantage-florida/" },
            ].map((p, i) => (
              <motion.div key={i} initial="hidden" whileInView="visible" viewport={{ once: true }} custom={i} variants={fadeUp}
                ...
                <div className="p-6">
                  ...
                  <Link href={p.href} className="inline-flex items-center gap-2 text-[0.9rem] font-bold transition-colors" style={{ color: p.color }}>
      ...
      <section className="py-20 lg:py-24" style={{ background: "white" }}>
        <div className="max-w-[1320px] mx-auto px-5 sm:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              { img: "https://d2xsxph8kpxj0f.cloudfront.net/310419663028505829/WdenMMm9jE8SydxXzr6dkt/blog-scooter-hero_48088844.jpg", category: "Coverage & Claims", title: "Medicare Prior Authorization and Appeals: What to Do When Care Is Delayed or Denied", desc: "A practical guide to coverage decisions, written notices, and the next action to take.", date: "Updated Aug 2026", href: "/medicare-prior-authorization-appeals/" },
              { img: "https://images.unsplash.com/photo-1506784983877-45594efa4cbe?w=600&h=400&fit=crop", category: "Plan Changes", title: "What Is a Medicare Plan Non-Renewal Notice and What Should I Do Next?", desc: "Understand a plan non-renewal notice and how to choose the next coverage path.", date: "Updated Aug 2026", href: "/faqs/medicare-plan-non-renewal-notice/" },
              { img: "https://images.unsplash.com/photo-1551836022-d5d88e9218df?w=600&h=400&fit=crop", category: "Checklist", title: "What to Do if Your Medicare Plan Drops a Doctor or Medication", desc: "Use a printable action checklist and learn what questions to ask your plan.", date: "Updated Aug 2026", href: "/faqs/what-to-do-if-medicare-plan-drops-doctor-or-drug/" },
            ].map((a, i) => (
      ...
      <section className="relative py-16 overflow-hidden" style={{ background: "linear-gradient(135deg, #0d1f5c 0%, #1a3fa8 100%)" }}>
        ...
        <div className="relative z-10 max-w-[1320px] mx-auto px-5 sm:px-8">
          <div className="flex flex-col lg:flex-row items-center justify-between gap-8">
            <div>
              <h2 className="text-2xl sm:text-3xl text-white mb-2" style={{ fontFamily: "var(--font-heading)" }}>Need Medicare help in Brandon or Tampa?</h2>
              <p className="text-[1rem] text-blue-200">Call the Brandon office or request a callback from a licensed Medicare specialist.</p>
            </div>
            <div className="flex flex-col sm:flex-row gap-4 shrink-0">
              <a href="tel:8136995559" className="inline-flex items-center justify-center gap-2 px-8 py-4 rounded-xl text-[1rem] font-bold" style={{ background: "linear-gradient(135deg, #f5a800 0%, #f59e0b 100%)", color: "#ffffff" }}>
                <Phone size={18} /> Call the Brandon Office
              </a>
              <Link href="/local-consultation/?city=Brandon&service=Medicare%20plan%20review&source=%2Fhomepage-local-preview%2F" className="inline-flex items-center justify-center gap-2 px-8 py-4 rounded-xl text-[1rem] font-bold text-white border-2 border-white/25 hover:border-white/50 transition-colors">
                Request a Local Callback <ArrowRight size={18} />
              </Link>
            </div>
          </div>
        </div>
...
function LocalAssistancePanel() {
  return (
    <section className="py-10 lg:py-12" style={{ background: "#f8f7f4" }}>
      <div className="max-w-[1240px] mx-auto px-5 sm:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-[1.12fr_0.88fr] gap-7 items-stretch rounded-2xl overflow-hidden" style={{ border: "1px solid #dbe4f6", background: "#ffffff" }}>
          <div className="p-7 sm:p-9 lg:p-10" style={{ background: "linear-gradient(135deg, #edf3ff 0%, #ffffff 70%)" }}>
            <div className="flex items-center gap-2 mb-4" style={{ color: "#1a3fa8", fontSize: "0.76rem", fontWeight: 800, letterSpacing: "0.14em", textTransform: "uppercase" }}><MapPin size={16} /> Local Medicare Help in Hillsborough County</div>
            <h2 className="text-2xl sm:text-3xl text-[#0d1f5c] mb-3" style={{ fontFamily: "var(--font-heading)" }}>Speak With a Licensed Medicare Specialist Serving Brandon and Tampa</h2>
            <p className="text-[0.98rem] text-slate-600 leading-relaxed max-w-2xl">Medicare Information Project is based at 915 Oakfield Dr, Suite A in Brandon and helps people in Brandon, Tampa, Riverview, Valrico, Apollo Beach, and nearby communities understand their Medicare options.</p>
            <div className="flex flex-wrap gap-3 mt-7">
              <a href="tel:8136995559" className="inline-flex items-center gap-2 px-5 py-3 rounded-xl font-bold text-[0.92rem]" style={{ background: "#f5a800", color: "#0d1f5c", textDecoration: "none" }}><Phone size={17} /> Call the Brandon Office</a>
              <Link href="/local-consultation/?city=Brandon&service=Medicare%20plan%20review&source=%2Fhomepage-local-preview%2F" className="inline-flex items-center gap-2 px-5 py-3 rounded-xl font-bold text-[0.92rem] text-white" style={{ background: "#1a3fa8", textDecoration: "none" }}>Request a Brandon Callback <ArrowRight size={16} /></Link>
              <Link href="/local-consultation/?city=Tampa&service=Medicare%20plan%20review&source=%2Fhomepage-local-preview%2F" className="inline-flex items-center gap-2 px-5 py-3 rounded-xl font-bold text-[0.92rem]" style={{ border: "1px solid #1a3fa8", color: "#1a3fa8", textDecoration: "none" }}>Request a Tampa Callback <ArrowRight size={16} /></Link>
            </div>
          </div>
          <div className="p-7 sm:p-9 lg:p-10 flex flex-col justify-center" style={{ background: "#0d1f5c" }}>
            <div style={{ color: "#f5a800", fontSize: "0.76rem", fontWeight: 800, letterSpacing: "0.14em", textTransform: "uppercase" }}>Explore Local Help</div>
            <p className="text-white text-xl font-bold mt-3 mb-5" style={{ fontFamily: "var(--font-heading)" }}>Start with the page that matches where you are.</p>
            <div className="flex flex-col gap-3">
              <Link href="/medicare-insurance-agent-brandon-fl/" className="inline-flex items-center justify-between rounded-lg px-4 py-3 text-[0.9rem] font-bold" style={{ background: "rgba(255,255,255,0.1)", color: "#ffffff", textDecoration: "none" }}>Medicare Agent in Brandon <ArrowRight size={16} /></Link>
              <Link href="/medicare-insurance-agent-tampa-fl/" className="inline-flex items-center justify-between rounded-lg px-4 py-3 text-[0.9rem] font-bold" style={{ background: "rgba(255,255,255,0.1)", color: "#ffffff", textDecoration: "none" }}>Medicare Agent in Tampa <ArrowRight size={16} /></Link>
              <Link href="/comparing-medicare-plans-brandon/" className="inline-flex items-center justify-between rounded-lg px-4 py-3 text-[0.9rem] font-bold" style={{ background: "rgba(255,255,255,0.1)", color: "#ffffff", textDecoration: "none" }}>Compare Medicare Plans in Brandon <ArrowRight size={16} /></Link>
            </div>
          </div>
        </div>
      </div>
...
function PrepareForReviewSection() {
  const items = [
    { icon: <Pill size={22} />, title: "Medication list", text: "Bring the medications you take, including dosage and pharmacy preference." },
    { icon: <Stethoscope size={22} />, title: "Doctors and care", text: "Write down the doctors, specialists, hospitals, and upcoming care that matter to you." },
    { icon: <BookOpen size={22} />, title: "Current plan details", text: "Have your Medicare card and current plan information nearby so you can ask focused questions." },
  ];
  return (
    <section className="py-20 lg:py-24" style={{ background: "#f8f9fb" }}>
      <div className="max-w-[1180px] mx-auto px-5 sm:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-[0.8fr_1.2fr] gap-10 items-start">
          <div>
            <p className="text-[0.8rem] font-bold uppercase tracking-[0.2em] mb-3" style={{ color: "#1a3fa8" }}>Prepare for Your Medicare Review</p>
            <h2 className="text-3xl sm:text-4xl text-gray-900 mb-4" style={{ fontFamily: "var(--font-heading)" }}>Make your next conversation more useful.</h2>
            <p className="text-[1rem] text-gray-600 leading-relaxed mb-6">A few details can help you focus the conversation on your doctors, prescriptions, budget, and questions. Start with local help in Brandon or Tampa when you are ready.</p>
            <div className="flex flex-wrap gap-x-5 gap-y-3">
              <Link href="/medicare-insurance-agent-brandon-fl/" className="font-bold text-[0.92rem]" style={{ color: "#1a3fa8" }}>Brandon Medicare help <ArrowRight className="inline" size={15} /></Link>
              <Link href="/medicare-insurance-agent-tampa-fl/" className="font-bold text-[0.92rem]" style={{ color: "#1a3fa8" }}>Tampa Medicare help <ArrowRight className="inline" size={15} /></Link>
            </div>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            {items.map((item) => (
              <div key={item.title} className="rounded-2xl p-6" style={{ background: "#ffffff", border: "1px solid #e5e7eb" }}>
                <div className="w-11 h-11 rounded-xl flex items-center justify-center mb-5" style={{ background: "#edf3ff", color: "#1a3fa8" }}>{item.icon}</div>
                <h3 className="font-bold text-[1rem] text-gray-900 mb-2">{item.title}</h3>
                <p className="text-[0.88rem] text-gray-600 leading-relaxed">{item.text}</p>
              </div>
            ))}
          </div>
        </div>
    ...
    <section className="py-20 lg:py-24 relative overflow-hidden" style={{ background: "#1a3fa8" }}>
      ...
      <div className="relative z-10 max-w-[1320px] mx-auto px-5 sm:px-8 text-center">
        <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeUp} custom={0}>
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-x-6 gap-y-2 mt-6 text-[0.88rem] text-blue-100">
            <span>Looking for a local conversation instead?</span>
            <Link href="/local-consultation/?city=Brandon&service=Medicare%20plan%20review&source=%2Fhomepage-local-preview%2F" className="font-bold text-white underline">Brandon callback</Link>
            <Link href="/local-consultation/?city=Tampa&service=Medicare%20plan%20review&source=%2Fhomepage-local-preview%2F" className="font-bold text-white underline">Tampa callback</Link>
          </div>
        </motion.div>
      </div>
    </section>
          ...
          <div className="lg:col-span-2">
            <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeUp} custom={2} className="sticky top-32 rounded-2xl overflow-hidden shadow-lg">
              ...
              <div className="p-8" style={{ background: "#0a1a4a" }}>
                <h3 className="text-xl text-white mb-3" style={{ fontFamily: "var(--font-heading)" }}>Need help in Brandon or Tampa?</h3>
                <p className="text-[0.9rem] text-blue-200 leading-relaxed mb-6">Call the Brandon office or request a callback from a licensed Medicare specialist.</p>
                <a href="tel:8136995559" className="w-full flex items-center justify-center gap-2 py-3.5 rounded-xl text-[0.95rem] font-bold mb-3" style={{ background: "linear-gradient(135deg, #f5a800 0%, #f59e0b 100%)", color: "#ffffff" }}>
                  <Phone size={16} /> Call the Brandon Office
                </a>
                <Link href="/local-consultation/?city=Tampa&service=Medicare%20plan%20review&source=%2Fhomepage-local-preview%2F" className="w-full flex items-center justify-center gap-2 py-3.5 rounded-xl text-[0.95rem] font-semibold text-white border-2 border-white/20 hover:border-white/40 transition-colors">
                  Request a Tampa Callback <ArrowRight size={16} />
                </Link>
              </div>
            </motion.div>
          </div>
