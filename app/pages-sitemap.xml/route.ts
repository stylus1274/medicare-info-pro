...
const LOCAL_PAGES: string[] = [
  ...
  "/comparing-medicare-plans-ocala",
  "/medicare-advantage-plans-ocala-florida",
  "/medicare-enrollment-assistance-ocala",
  "/medicare-agent-the-villages",
  "/medicare-supplement-insurance-plans-the-villages",
  "/comparing-medicare-plans-the-villages",
  "/medicare-advantage-plans-the-villages-florida",
  "/medicare-enrollment-assistance-the-villages",
  "/medicare-agent-leesburg",
  "/medicare-supplement-insurance-plans-leesburg",
