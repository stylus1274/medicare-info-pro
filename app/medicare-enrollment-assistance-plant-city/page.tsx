...
const webpageSchema = {
  ...
  "@type": "WebPage",
  "name": "Medicare Enrollment Assistance Plant City FL | Medicare Information Project",
  "url": "https://medicareinfopro.com/medicare-enrollment-assistance-plant-city",
  "isPartOf": {
...
const localBusinessSchema = {
  "@context": "https://schema.org",
  "@type": "LocalBusiness",
  "@id": "https://medicareinfopro.com/medicare-enrollment-assistance-plant-city#localbusiness",
  "name": "Medicare Information Pro",
      ...
      config={{
        ...
        faqs: [
          ...
          },
          {
            ...
            a: "Yes. We serve eastern Hillsborough County communities including Valrico, Brandon, and Seffner.",
          },
        ],
        relatedLinks: [
