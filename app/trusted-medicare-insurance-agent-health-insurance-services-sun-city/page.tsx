...
const webpageSchema = {
  ...
  "@type": "WebPage",
  "name": "Trusted Medicare Insurance Agent Health Insurance Services Sun City FL | Medicare Information Project",
  "url": "https://medicareinfopro.com/trusted-medicare-insurance-agent-health-insurance-services-sun-city",
  "isPartOf": {
...
const localBusinessSchema = {
  "@context": "https://schema.org",
  "@type": "LocalBusiness",
  "@id": "https://medicareinfopro.com/trusted-medicare-insurance-agent-health-insurance-services-sun-city#localbusiness",
  "name": "Medicare Information Pro",
