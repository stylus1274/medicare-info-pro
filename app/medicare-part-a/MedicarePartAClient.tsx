            ...
            <div className="rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
              ...
              <div className="px-5 py-5 space-y-3">
                <div className="flex items-center gap-3">
                  <img src="https://d2xsxph8kpxj0f.cloudfront.net/310419663028505829/WdenMMm9jE8SydxXzr6dkt/greg-wohl-author_kbxfzwfm.jpg" alt="Greg Wohl, Licensed Medicare Advisor" className="w-10 h-10 rounded-full object-cover object-top" />
                  <div>
