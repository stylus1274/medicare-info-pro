      ...
      <div className="min-h-screen bg-white">
        ...
        <section className="bg-[#0d2d6b] text-white py-12 md:py-16">
          <div className="max-w-6xl mx-auto px-4">
            ...
            <Breadcrumb items={[{ label: "Home", href: "/" }, { label: "Coverage", href: "/coverage-qa" }, { label: "Cancer Treatment" }]} className="mb-4" />
            <h1
                    ...
                    <table className="w-full text-sm">
                      ...
                      <tbody>
                        {[
                          ...
                          { service: "Oral chemotherapy drug (Part D)", medicare: "Varies by formulary tier", you: "Up to $2,100 annual OOP cap (2026)" },
