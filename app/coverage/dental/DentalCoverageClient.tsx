      ...
      <div className="max-w-[1200px] mx-auto px-5 sm:px-8 py-12 w-full flex-1">
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_300px] gap-12">
          ...
          <article className="space-y-10 min-w-0">
            ...
            {/* Vision Cross-Link Callout */}
            <section className="rounded-2xl border border-amber-200 bg-amber-50 p-6">
              <h2
                className="text-base font-bold text-gray-900 mb-2"
                style={{ fontFamily: "'Merriweather', serif" }}
              >
                Also Missing from Original Medicare: Vision Coverage
              </h2>
              <p className="text-sm text-gray-700 leading-relaxed mb-4">
                Like dental, routine eye exams and glasses are excluded from Original Medicare.
                Medicare Advantage plans often bundle dental, vision, and hearing benefits
                together. If you are considering switching for dental coverage, compare vision
