...
const faqs = [
  ...
  },
  {
    ...
    a: "Starting in 2026, the Medicare Part D out-of-pocket cap is $2,100 per year. Once you reach this amount in true out-of-pocket costs, you pay $0 for covered drugs for the rest of the year. This is a major improvement from prior years and eliminates the coverage gap (donut hole) that previously existed.",
  },
  {
              ...
              <div id="2026-changes" className="mb-12">
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  {[
                    {
                      icon: DollarSign,
                      title: "$2,100 Out-of-Pocket Cap",
                      desc: "Starting in 2026, your annual out-of-pocket costs for Part D are capped at $2,100. Once you reach this limit, you pay $0 for covered drugs for the rest of the year. This eliminates the catastrophic coverage phase.",
