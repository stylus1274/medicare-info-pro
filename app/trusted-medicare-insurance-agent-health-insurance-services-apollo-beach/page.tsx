...
const webpageSchema = {
  ...
  "@type": "WebPage",
  "name": "Trusted Medicare Insurance Agent Health Insurance Services Apollo Beach FL | Medicare Information Project",
  "url": "https://medicareinfopro.com/trusted-medicare-insurance-agent-health-insurance-services-apollo-beach",
  "isPartOf": {
...
const localBusinessSchema = {
  "@context": "https://schema.org",
  "@type": "LocalBusiness",
  "@id": "https://medicareinfopro.com/trusted-medicare-insurance-agent-health-insurance-services-apollo-beach#localbusiness",
  "name": "Medicare Information Pro",
